    ...
    <div class="register-box">
        ...
        <div class="card">
            <div class="card-body register-card-body">
                <p class="login-box-msg">Temani Ngopi Cafe</p>
                <form action="/register" method="post">
                    @csrf
                    {{-- <div class="input-group mb-3">
                        <input type="text" class="form-control is-invalid  @error('name') is-invalid @enderror"
                            placeholder="Full name" name="name" id="validationServer03"
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                            id="validationServer03" aria-describedby="validationServer03Feedback" name="name" required
